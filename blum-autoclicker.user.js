...
// @downloadURL  https://github.com/Davud77/autoclicker/raw/refs/heads/main/blum-autoclicker.user.js
// @updateURL    https://github.com/Davud77/autoclicker/raw/refs/heads/main/blum-autoclicker.user.js
...
try {
    ...
    // Обновленная функция для периодической проверки наличия ошибки
    function continuousErrorCheck() {
        handleErrorPage();
        const randomDelay = Math.floor(Math.random() * (100000 - 1000 + 1)) + 1000; // Случайное число от 1000 до 100000
        setTimeout(continuousErrorCheck, randomDelay);
    }
    ...
    continuousErrorCheck(); // Запускаем проверку на наличие ошибки
